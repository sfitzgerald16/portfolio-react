      ...
      <nav className="navbar is-dark has-text-white" role="navigation" aria-label="main navigation">
        ...
        <div className="navbar-end">
          <div className="navbar-item">
            ...
            <a href="https://github.com/sfitzgerald16" className="button" target='_blank'>
              <FontAwesomeIcon icon={['fab', 'github']} className='has-text-white' size='2x'/>
            </a>
            <a href="https://www.linkedin.com/in/shannon-fitzgerald" className="button" target='_blank'>
